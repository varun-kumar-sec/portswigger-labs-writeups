...
After configuring session handling, ***In the resource pool section of intruder i created a custom resource pool and set it's Maximum concurrent request to 1***, And then i launched the brute-force attack against the security code field.
